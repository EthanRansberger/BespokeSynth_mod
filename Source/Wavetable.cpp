...
float Wavetable::DetectSampleFrequency()
{
...
void Wavetable::GetModuleDimensions(float& width, float& height)
{
   width = 210;
   height = 90;
}

void Wavetable::FilesDropped(std::vector<std::string> files, int x, int y)
{
   Sample sample;
